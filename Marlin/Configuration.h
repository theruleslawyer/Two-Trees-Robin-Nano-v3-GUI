...
//#define BTT_FILAMENT_RUNOUT_SENSOR
...
#define STRING_CONFIG_H_AUTHOR "(TheRulesLawyer, MKS Robin Nano v3)" // Who made the changes.
 ...
 */
//#define FILAMENT_RUNOUT_SENSOR
#if EITHER (FILAMENT_RUNOUT_SENSOR,BTT_FILAMENT_RUNOUT_SENSOR)
  ...
  #if ENABLED(BTT_FILAMENT_RUNOUT_SENSOR)
